...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\AddFileController' => 'getAddFileControllerService',
            'App\\Controller\\ContactController' => 'getContactControllerService',
            'App\\Controller\\FormulasController' => 'getFormulasControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\LockController' => 'getLockControllerService',
            'App\\Controller\\UpdateFile' => 'getUpdateFileService',
    ...
    /**
     * Gets the public 'App\Controller\AddFileController' shared autowired service.
     *
     * @return \App\Controller\AddFileController
     */
    protected function getAddFileControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\HelperTrait.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\AddFileController.php';

        $this->services['App\\Controller\\AddFileController'] = $instance = new \App\Controller\AddFileController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\AddFileController', $this));
    ...
    /**
     * Gets the public 'App\Controller\FormulasController' shared autowired service.
     *
     * @return \App\Controller\FormulasController
     */
    protected function getFormulasControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\FormulasController.php';

        $this->services['App\\Controller\\FormulasController'] = $instance = new \App\Controller\FormulasController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\FormulasController', $this));
    ...
    protected function getHomeControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\HomeController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\LockController' shared autowired service.
     *
     * @return \App\Controller\LockController
     */
    protected function getLockControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\LockController.php';

        $this->services['App\\Controller\\LockController'] = $instance = new \App\Controller\LockController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\LockController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\UpdateFile' shared autowired service.
     *
     * @return \App\Controller\UpdateFile
     */
    protected function getUpdateFileService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\HelperTrait.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\UpdateFile.php';

        $this->services['App\\Controller\\UpdateFile'] = $instance = new \App\Controller\UpdateFile();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\UpdateFile', $this));
    ...
    protected function getPersisterInterfaceService($lazyLoad = true)
    {
        ...
        return $this->services['Scheb\\TwoFactorBundle\\Model\\PersisterInterface'] = (new \Scheb\TwoFactorBundle\Model\Persister\DoctrinePersisterFactory(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL))->getPersister();
    }
    ...
    protected function getTwoFactorFormRendererInterfaceService($lazyLoad = true)
    {
        ...
        return $this->services['Scheb\\TwoFactorBundle\\Security\\TwoFactor\\Provider\\TwoFactorFormRendererInterface'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\DefaultTwoFactorFormRenderer(($this->services['twig'] ?? $this->getTwigService()), '@SchebTwoFactor/Authentication/form.html.twig');
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('oAnz8c9+jo', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m5cR1QEFrm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\FilesRepository' => ['privates', 'App\\Repository\\FilesRepository', 'getFilesRepositoryService', false],
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('security.authentication.success', [0 => function () {
            return ($this->privates['security.authentication.authentication_success_event_suppressor.two_factor.main'] ?? ($this->privates['security.authentication.authentication_success_event_suppressor.two_factor.main'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Event\AuthenticationSuccessEventSuppressor('main')));
    ...
    protected function getSchebTwoFactor_FirewallContextService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\TwoFactorFirewallConfig.php';

        return $this->services['scheb_two_factor.firewall_context'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\TwoFactorFirewallContext(['main' => new \Scheb\TwoFactorBundle\Security\TwoFactor\TwoFactorFirewallConfig(['auth_form_path' => '2fa_login', 'check_path' => '2fa_login_check', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'success_handler' => NULL, 'failure_handler' => NULL, 'authentication_required_handler' => NULL, 'auth_code_parameter_name' => '_auth_code', 'trusted_parameter_name' => '_trusted', 'multi_factor' => false, 'prepare_on_login' => false, 'prepare_on_access_denied' => false, 'csrf_token_generator' => NULL, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'two_factor', 'provider' => NULL])]);
    }
    ...
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Provider\\Google\\GoogleAuthenticatorInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Provider\\Google\\GoogleAuthenticator.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Provider\\Google\\GoogleTotpFactory.php';

        return $this->services['scheb_two_factor.security.google_authenticator'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\Google\GoogleAuthenticator(new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\Google\GoogleTotpFactory(NULL, NULL, 6), 1);
    }
    ...
    /**
     * Gets the private '.errored..service_locator.EDbJuHk.App\Entity\Files' shared service.
     *
     * @return \App\Entity\Files
     */
    protected function getFilesService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\Entity\\Files.php';

        return $this->privates['.errored..service_locator.EDbJuHk.App\\Entity\\Files'] = new \App\Entity\Files();
    }

    /**
     * Gets the private '.service_locator.98sdd14' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_98sdd14Service()
    {
        return $this->privates['.service_locator.98sdd14'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\UpdateFile::delete' => ['privates', '.service_locator.ipjTSUc', 'get_ServiceLocator_IpjTSUcService', false],
            'App\\Controller\\UpdateFile::update' => ['privates', '.service_locator.EDbJuHk', 'get_ServiceLocator_EDbJuHkService', false],
            'App\\Controller\\UserController::check2fa' => ['privates', '.service_locator.m28IDl7', 'get_ServiceLocator_M28IDl7Service', false],
            'App\\Controller\\UserController::login' => ['privates', '.service_locator.g.xob4v', 'get_ServiceLocator_G_Xob4vService', false],
            'App\\Controller\\UserController::register' => ['privates', '.service_locator.X4LBDwH', 'get_ServiceLocator_X4LBDwHService', false],
            'App\\Controller\\UserController::updatemdp' => ['privates', '.service_locator.ccM2MGC', 'get_ServiceLocator_CcM2MGCService', false],
            'App\\Controller\\UpdateFile:delete' => ['privates', '.service_locator.ipjTSUc', 'get_ServiceLocator_IpjTSUcService', false],
            'App\\Controller\\UpdateFile:update' => ['privates', '.service_locator.EDbJuHk', 'get_ServiceLocator_EDbJuHkService', false],
            'App\\Controller\\UserController:check2fa' => ['privates', '.service_locator.m28IDl7', 'get_ServiceLocator_M28IDl7Service', false],
            'App\\Controller\\UserController:login' => ['privates', '.service_locator.g.xob4v', 'get_ServiceLocator_G_Xob4vService', false],
            ...
            'App\\Controller\\UpdateFile::delete' => '?',
            'App\\Controller\\UpdateFile::update' => '?',
            'App\\Controller\\UserController::check2fa' => '?',
            'App\\Controller\\UserController::login' => '?',
            'App\\Controller\\UserController::register' => '?',
            'App\\Controller\\UserController::updatemdp' => '?',
            'App\\Controller\\UpdateFile:delete' => '?',
            'App\\Controller\\UpdateFile:update' => '?',
            'App\\Controller\\UserController:check2fa' => '?',
            'App\\Controller\\UserController:login' => '?',
    ...
    /**
     * Gets the private '.service_locator.EDbJuHk' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_EDbJuHkService()
    {
        return $this->privates['.service_locator.EDbJuHk'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'em' => ['services', 'doctrine.orm.default_entity_manager', 'getDoctrine_Orm_DefaultEntityManagerService', false],
            'file' => ['privates', '.errored..service_locator.EDbJuHk.App\\Entity\\Files', NULL, 'Cannot autowire service ".service_locator.EDbJuHk": it references class "App\\Entity\\Files" but no such service exists.'],
        ], [
            'em' => '?',
            'file' => 'App\\Entity\\Files',
        ]);
    }

    /**
     * Gets the private '.service_locator.X4LBDwH' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_X4LBDwHService()
    {
        return $this->privates['.service_locator.X4LBDwH'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'authenticator' => ['services', 'scheb_two_factor.security.google_authenticator', 'getSchebTwoFactor_Security_GoogleAuthenticatorService', false],
    ...
    /**
     * Gets the private '.service_locator.m28IDl7' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_M28IDl7Service()
    {
        return $this->privates['.service_locator.m28IDl7'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'authenticator' => ['services', 'scheb_two_factor.security.google_authenticator', 'getSchebTwoFactor_Security_GoogleAuthenticatorService', false],
        ], [
            'authenticator' => '?',
        ]);
     ...
     */
    protected function getFilesRepositoryService()
    {
    ...
    protected function getQrCodeRuntimeService()
    {
        ...
        return $this->privates['Endroid\\QrCodeBundle\\Twig\\QrCodeRuntime'] = new \Endroid\QrCodeBundle\Twig\QrCodeRuntime(($this->privates['Endroid\\QrCode\\Factory\\QrCodeFactory'] ?? $this->getQrCodeFactoryService()), ($this->services['router'] ?? $this->getRouterService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CmZPU9QXUs', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QTgAPZgoU3', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ytUT32O66z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7uoy6aJC3B', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uHcrbU62Zn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+HmIJn+4KL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['debug.security.voter.security.access.simple_role_voter'] ?? $this->getDebug_Security_Voter_Security_Access_SimpleRoleVoterService());
    ...
    protected function getSchebTwoFactor_AuthenticatedTokenHandlerService($lazyLoad = true)
    {
        ...
        return $this->privates['scheb_two_factor.authenticated_token_handler'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Handler\AuthenticatedTokenHandler($this->getSchebTwoFactor_IpWhitelistHandlerService(), $this->parameters['scheb_two_factor.security_tokens']);
    }
    ...
    protected function getSchebTwoFactor_IpWhitelistHandlerService($lazyLoad = true)
    {
        ...
        return new \Scheb\TwoFactorBundle\Security\TwoFactor\Handler\IpWhitelistHandler($this->getSchebTwoFactor_TrustedDeviceHandlerService(), new \Scheb\TwoFactorBundle\Security\TwoFactor\IpWhitelist\DefaultIpWhitelistProvider([]));
    }
    ...
    /**
     * Gets the private 'scheb_two_factor.security.google.form_renderer' shared service.
     *
     * @return \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\DefaultTwoFactorFormRenderer
     */
    protected function getSchebTwoFactor_Security_Google_FormRendererService($lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Provider\\TwoFactorFormRendererInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Provider\\DefaultTwoFactorFormRenderer.php';
    ...
    protected function getSchebTwoFactor_Security_Google_ProviderService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Provider\\Google\\GoogleAuthenticatorTwoFactorProvider.php';

        return $this->privates['scheb_two_factor.security.google.provider'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\Google\GoogleAuthenticatorTwoFactorProvider(($this->services['scheb_two_factor.security.google_authenticator'] ?? $this->getSchebTwoFactor_Security_GoogleAuthenticatorService()), $this->getSchebTwoFactor_Security_Google_FormRendererService());
    }
    ...
    {
        return $this->privates['scheb_two_factor.trusted_cookie_response_listener'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\TrustedCookieResponseListener($this->getSchebTwoFactor_TrustedTokenStorageService(), 5184000, 'trusted_device', false, 'lax', NULL);
    }
    ...
    protected function getSchebTwoFactor_TrustedDeviceHandlerService($lazyLoad = true)
    {
        ...
        return new \Scheb\TwoFactorBundle\Security\TwoFactor\Handler\TrustedDeviceHandler($this->getSchebTwoFactor_ProviderHandlerService(), ($this->privates['scheb_two_factor.null_trusted_device_manager'] ?? ($this->privates['scheb_two_factor.null_trusted_device_manager'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\NullTrustedDeviceManager())), false);
    }
    ...
    /**
     * Gets the private 'security.authentication.listener.two_factor.main' shared service.
     *
     * @return \Scheb\TwoFactorBundle\Security\Http\Firewall\TwoFactorListener
     */
    protected function getSecurity_Authentication_Listener_TwoFactor_MainService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Http\\Firewall\\TwoFactorListener.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\security-http\\Authentication\\AuthenticationSuccessHandlerInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\security-http\\Util\\TargetPathTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Http\\Authentication\\DefaultAuthenticationSuccessHandler.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\security-http\\Authentication\\AuthenticationFailureHandlerInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Http\\Authentication\\DefaultAuthenticationFailureHandler.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Http\\Authentication\\AuthenticationRequiredHandlerInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Http\\Authentication\\DefaultAuthenticationRequiredHandler.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Csrf\\CsrfTokenValidator.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\security-csrf\\CsrfTokenManagerInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Csrf\\NullCsrfTokenManager.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Authorization\\TwoFactorAccessDecider.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Trusted\\TrustedDeviceManagerInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Trusted\\NullTrustedDeviceManager.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Authentication\\Token\\TwoFactorTokenFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\Authentication\\Token\\TwoFactorTokenFactory.php';
        ...
        return $this->privates['security.authentication.listener.two_factor.main'] = new \Scheb\TwoFactorBundle\Security\Http\Firewall\TwoFactorListener(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), $a, 'main', new \Scheb\TwoFactorBundle\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($a, 'main', ['auth_form_path' => '2fa_login', 'check_path' => '2fa_login_check', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'success_handler' => NULL, 'failure_handler' => NULL, 'authentication_required_handler' => NULL, 'auth_code_parameter_name' => '_auth_code', 'trusted_parameter_name' => '_trusted', 'multi_factor' => false, 'prepare_on_login' => false, 'prepare_on_access_denied' => false, 'csrf_token_generator' => NULL, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'two_factor', 'provider' => NULL]), new \Scheb\TwoFactorBundle\Security\Http\Authentication\DefaultAuthenticationFailureHandler($a, ['auth_form_path' => '2fa_login', 'check_path' => '2fa_login_check', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'success_handler' => NULL, 'failure_handler' => NULL, 'authentication_required_handler' => NULL, 'auth_code_parameter_name' => '_auth_code', 'trusted_parameter_name' => '_trusted', 'multi_factor' => false, 'prepare_on_login' => false, 'prepare_on_access_denied' => false, 'csrf_token_generator' => NULL, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'two_factor', 'provider' => NULL]), new \Scheb\TwoFactorBundle\Security\Http\Authentication\DefaultAuthenticationRequiredHandler($a, 'main', ['auth_form_path' => '2fa_login', 'check_path' => '2fa_login_check', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'success_handler' => NULL, 'failure_handler' => NULL, 'authentication_required_handler' => NULL, 'auth_code_parameter_name' => '_auth_code', 'trusted_parameter_name' => '_trusted', 'multi_factor' => false, 'prepare_on_login' => false, 'prepare_on_access_denied' => false, 'csrf_token_generator' => NULL, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'two_factor', 'provider' => NULL]), new \Scheb\TwoFactorBundle\Security\TwoFactor\Csrf\CsrfTokenValidator(new \Scheb\TwoFactorBundle\Security\TwoFactor\Csrf\NullCsrfTokenManager(), ['auth_form_path' => '2fa_login', 'check_path' => '2fa_login_check', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'success_handler' => NULL, 'failure_handler' => NULL, 'authentication_required_handler' => NULL, 'auth_code_parameter_name' => '_auth_code', 'trusted_parameter_name' => '_trusted', 'multi_factor' => false, 'prepare_on_login' => false, 'prepare_on_access_denied' => false, 'csrf_token_generator' => NULL, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'two_factor', 'provider' => NULL]), ['auth_form_path' => '2fa_login', 'check_path' => '2fa_login_check', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'success_handler' => NULL, 'failure_handler' => NULL, 'authentication_required_handler' => NULL, 'auth_code_parameter_name' => '_auth_code', 'trusted_parameter_name' => '_trusted', 'multi_factor' => false, 'prepare_on_login' => false, 'prepare_on_access_denied' => false, 'csrf_token_generator' => NULL, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'two_factor', 'provider' => NULL], ($this->privates['scheb_two_factor.null_trusted_device_manager'] ?? ($this->privates['scheb_two_factor.null_trusted_device_manager'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\Trusted\NullTrustedDeviceManager())), new \Scheb\TwoFactorBundle\Security\Authorization\TwoFactorAccessDecider(($this->privates['security.access_map'] ?? $this->getSecurity_AccessMapService()), ($this->privates['debug.security.access.decision_manager'] ?? $this->getDebug_Security_Access_DecisionManagerService()), $a, ($this->privates['security.logout_url_generator'] ?? $this->getSecurity_LogoutUrlGeneratorService())), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), ($this->privates['scheb_two_factor.default_token_factory'] ?? ($this->privates['scheb_two_factor.default_token_factory'] = new \Scheb\TwoFactorBundle\Security\Authentication\Token\TwoFactorTokenFactory())), ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.guard.main.two_factor_decorator'] ?? $this->getSecurity_Authentication_Provider_Guard_Main_TwoFactorDecoratorService());
            yield 1 => ($this->privates['security.authentication.provider.two_factor.main'] ?? $this->getSecurity_Authentication_Provider_TwoFactor_MainService());
            yield 2 => ($this->privates['security.authentication.provider.anonymous.main.two_factor_decorator'] ?? $this->getSecurity_Authentication_Provider_Anonymous_Main_TwoFactorDecoratorService());
        }, 3), true);
    ...
    protected function getSecurity_Authentication_Provider_Guard_Main_TwoFactorDecoratorService()
    {
        ...
        return $this->privates['security.authentication.provider.guard.main.two_factor_decorator'] = new \Scheb\TwoFactorBundle\Security\Authentication\Provider\AuthenticationProviderDecorator(new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\AppUserAuthenticator'] ?? $this->getAppUserAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.user_provider'] ?? $this->getSecurity_User_Provider_Concrete_UserProviderService()), 'main', new \Symfony\Component\Security\Core\User\UserChecker(), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService())), ($this->privates['scheb_two_factor.authenticated_token_handler'] ?? $this->getSchebTwoFactor_AuthenticatedTokenHandlerService()), ($this->privates['scheb_two_factor.authentication_context_factory'] ?? ($this->privates['scheb_two_factor.authentication_context_factory'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\AuthenticationContextFactory('Scheb\\TwoFactorBundle\\Security\\TwoFactor\\AuthenticationContext'))), ($this->privates['security.firewall.map'] ?? $this->getSecurity_Firewall_MapService()), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));
    }

    /**
     * Gets the private 'security.authentication.provider.two_factor.main' shared service.
     *
     * @return \Scheb\TwoFactorBundle\Security\Authentication\Provider\TwoFactorAuthenticationProvider
     */
    protected function getSecurity_Authentication_Provider_TwoFactor_MainService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\security-core\\Authentication\\Provider\\AuthenticationProviderInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'\\vendor\\scheb\\two-factor-bundle\\Security\\TwoFactor\\Backup\\NullBackupCodeManager.php';

        return $this->privates['security.authentication.provider.two_factor.main'] = new \Scheb\TwoFactorBundle\Security\Authentication\Provider\TwoFactorAuthenticationProvider('main', ['auth_form_path' => '2fa_login', 'check_path' => '2fa_login_check', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'success_handler' => NULL, 'failure_handler' => NULL, 'authentication_required_handler' => NULL, 'auth_code_parameter_name' => '_auth_code', 'trusted_parameter_name' => '_trusted', 'multi_factor' => false, 'prepare_on_login' => false, 'prepare_on_access_denied' => false, 'csrf_token_generator' => NULL, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'two_factor', 'provider' => NULL], ($this->privates['scheb_two_factor.provider_registry'] ?? $this->getSchebTwoFactor_ProviderRegistryService()), new \Scheb\TwoFactorBundle\Security\TwoFactor\Backup\NullBackupCodeManager(), ($this->privates['scheb_two_factor.provider_preparation_recorder'] ?? $this->getSchebTwoFactor_ProviderPreparationRecorderService()));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($b, 'home'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']);
        ...
        return $this->privates['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['security.authentication.listener.two_factor.main'] ?? $this->getSecurity_Authentication_Listener_TwoFactor_MainService());
        ...
        }, 6), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($this->privates['scheb_two_factor.security.authentication.trust_resolver'] ?? $this->getSchebTwoFactor_Security_Authentication_TrustResolverService()), $b, 'main', ($this->privates['App\\Security\\AppUserAuthenticator'] ?? $this->getAppUserAuthenticatorService()), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.user_provider', 'main', 'App\\Security\\AppUserAuthenticator', NULL, NULL, [0 => 'guard', 1 => 'two_factor', 2 => 'anonymous'], NULL), ($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())));
    }
